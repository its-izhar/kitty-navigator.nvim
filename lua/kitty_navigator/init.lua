...
function M.navigate(direction)
  ...
  if direction == "down" then direction = "bottom" end
  if direction == "up" then direction = "top" end
...
-----------------------------------------------------------------------
function M.left()   M.navigate("left")   end
function M.right()  M.navigate("right")  end
function M.up()     M.navigate("top")    end
function M.down()   M.navigate("bottom") end
function M.top()    M.navigate("top")    end
function M.bottom() M.navigate("bottom") end
